...
\section*{Aufgabe 5}
\subsection*{a)}
Zu Beginn, setzen wir alle Kanten, welche die Kapazitäten repräsentieren auf 1. Mithilfe des Maxflow-Mincut Algorithmus, wie er in Aufgabe 3 beschrieben wurde, können wir nun den Mincut berchenen. Da wir alle Kanten zuvor auf 1 gesetzt haben, liefert der Mincut Algorithmus genau die Zusammenhangszahl des Graphen.
